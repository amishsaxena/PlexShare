...
namespace PlexShareScreenshare.Client
{
    ...
    public class Screenshot
    {
        ...
        /// <summary>
        /// Protected constructor inorder so that making new objects of this class from outside is not supported.
        /// </summary>
        ...
        /// <summary>
        /// For implementing singleton class of Screenshot.
        /// </summary>
        /// <returns>The singleton instance of Screenshot object.</returns>
        ...
        public Bitmap MakeScreenshot(Int32 displayIndex = 0, Int32 adapterIndex = 0, Int32 maxTimeout = 5000)
        {
            ...
            {
                // if the next frame could not be captured due to some reasons
                return null;
            }
            ...
            return (new Bitmap(_bitmap, 2 * _bitmap.Width / 3, 2 * _bitmap.Height / 3)) ;
        }
        ...
        /// <summary>
        /// Disposes the class members to avoid memory hogging.
        /// </summary>
